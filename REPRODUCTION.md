...
artifacts for the TAP-Correct V1 release.
...
dataset and are not prerequisites for the formal Strawberry release:
...
python scripts/strawberryds_eval.py --mode indomain
```
